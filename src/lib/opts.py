...
class opts(object):
    def __init__(self):
        ...
        # VRAN
        self.parser.add_argument('--val_mft24', default=False, help='val mft24')
        self.parser.add_argument('--test_mft24', default=False, help='test mft24')
